...
from SCAN.model.SCANmaskar_gpt_dis import SCANARTransformer, batch_apply_rotary_emb
from SCAN.model.llamagen_gpt import apply_rotary_emb
from SCAN.model.generate import sample
from SCAN.model.utils import calculate_num_query_tokens_for_parallel_decoding
...
def generate_resolution_extrapolation(
    ...
    # Step-1: Generate the token orders and result sequences (Same as regular SCAN)
    ...
    # Step-3: Prepare the freqs_cis and position_instruction_tokens (Same as regular SCAN)
