...
from SCAN.applications.resolution_extrapolation import generate_resolution_extrapolation
...
if __name__ == "__main__":
    ...
    parser.add_argument("--config", type=str, default="configs/SCAN/randar_xl_0.7b.yaml")
